  ...
  Guesstimates: [
    {
      ...
      evaluationNote: `CRITICAL RULE — READ FIRST:
Emoji sharing is NOT a message type. 
Never deduct for omitting it. Ever.
Any deduction for missing emoji is wrong.
For this specific question, the correct ambiguity is the definition of "messages."
...
`,
      topAnswer: `Before I structure this — one quick clarification. When you say messages, are we estimating across all types — text, voice notes, media, and group messages — or a specific subset? The individual versus group distinction especially will significantly change my decomposition.`,
    },
    {
      id: "g2",
...
- No reason given → deduct 1 additional`,
      topAnswer: `Before I structure this — one quick clarification. Should I estimate across all Uber services — cab rides, autos, bikes, and delivery — or scope this to passenger transportation only? Each has significantly different frequency and volume patterns.`,
    },
    {
      id: "g3",
...
- No reason given → deduct 1 additional`,
      topAnswer: `Before I structure this — one quick clarification. When you say videos, should I include all content types — Shorts, long-form videos, and live streams — or a specific subset? Upload frequency and volume vary significantly across these.`,
    },
    {
      id: "g4",
...
- No reason given → deduct 1 additional`,
      topAnswer: `Before I structure this — one quick clarification. When you say Swiggy orders, should I include all verticals — food delivery, Instamart, and Genie — or scope this to food delivery only? Each has significantly different order frequency and basket size, which changes my baseline entirely.`,
    },
  ],
  RCA: [],
  "Product Sense": [],
